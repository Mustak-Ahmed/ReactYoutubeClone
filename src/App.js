...
import Comment from './components/comment_box/Comment';
import './App.css';
...
class App extends Component {
  ...
  componentDidMount() {
    this.searchVideoHandler('Alan Walker'); // for default will be Alan Walker :>
  }

  searchVideoHandler = term => YTSearch({key: API_KEY, term},
